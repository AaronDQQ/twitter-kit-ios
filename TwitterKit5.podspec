Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/AaronDQQ/twitter-kit-ios"
  s.documentation_url = "https://github.com/AaronDQQ/twitter-kit-ios/wiki"
  s.social_media_url = "https://taoren.me"
  s.authors = "AaronDQQ"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/AaronDQQ/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
